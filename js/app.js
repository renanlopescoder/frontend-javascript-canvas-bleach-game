...
function checkCollision(object, player) {
  return (player.x > object.x - object.hitBox.x/2 &&
          player.x < object.x + object.hitBox.x/1 &&
...
Prize.prototype.update = function(dt) {
  ...
  if (checkCollision(this, player)) {
    ...
    if(pontuacao == 100){
      alert("Parabéns Ichigo Hollow foi derrotado agora próxima fase");
      window.location='renanlopes.com/projects/bleach-game-2/index.html'
    }
  }
};
